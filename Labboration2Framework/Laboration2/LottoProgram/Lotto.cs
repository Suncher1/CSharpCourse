    ...
    public partial class Lotto : Form
    {
        ...
        private void LottoStartButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < numberOfPulls; i++)
            {
                ...
                //lottoRow = new int[] { 1, 2, 3, 4, 5, 6, 7 };
                //randomLottoRow = new int[] { 1, 2, 3, 4, 5, 8, 9 };
            ...
            string rightAnswersFiveText = rightAnswersFive.ToString();
            string rightAnswersSixText = rightAnswersSix.ToString();
            string rightAnswersSevenText = rightAnswersSeven.ToString();

            FiveRightBox.Text = rightAnswersFiveText;
            SixRightBox.Text = rightAnswersSixText;
            SevenRightBox.Text = rightAnswersSevenText;
        }
    }
}
